    ...
    <div class="actions">
        <ul>
            ...
            <?php if ($auth_is_admin): ?>
                <li><?php echo $html->link('Eliminar criterio', array('action' => 'delete', $competence_criterion['CompetenceCriterion']['id']), null, 'Cuando elimina un criterio, elimina también las rúbricas y todas las calificaciones. ¿Está seguro que desea borrarlo?') ?></li>
            <?php endif; ?>
        </ul>
    </div>
<?php endif; ?>
