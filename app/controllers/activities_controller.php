...
class ActivitiesController extends AppController {
    ...
    function view($id = null) {
        ...
        $this->set('registrations', $this->Activity->query("SELECT Registration.*, Student.*, ChildSubject.code, ChildSubject.name FROM subjects_users SU INNER JOIN users Student ON SU.user_id = Student.id LEFT JOIN subjects ChildSubject ON SU.child_subject_id IS NOT NULL AND ChildSubject.id = SU.child_subject_id LEFT JOIN registrations Registration ON Registration.student_id = SU.user_id AND Registration.activity_id = {$id} WHERE SU.subject_id = {$subject['Subject']['id']} ORDER BY Student.last_name, Student.first_name"));
    }
